...
public class hikisu_modorichi3 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet hikisu_modorichi3</title>");            
            out.println("</head>");
            out.println("<body>");
            //out.println("<h1>Servlet hikisu_modorichi3 at " + request.getContextPath() + "</h1>");
            printMultiProfile(out);
 ...
 void printMultiProfile(PrintWriter out){
