...
public class hikisu_modorichi1 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet hikisu_modorichi1</title>");            
            out.println("</head>");
            out.println("<body>");
            //out.println("<h1>Servlet hikisu_modorichi1 at " + request.getContextPath() + "</h1>");
    ...
    void printMultiProfile(PrintWriter out, int num){
        ...
        String num_casted = Integer.toString(num);
        String content;
        
        if(num_casted.equals(profile1.get(0))){
            for(int i = 1; i <= 3; i++){
        ...
        }else if(num_casted.equals(profile2.get(0))){
            for(int i = 1; i <= 3; i++){
        ...
        }else if(num_casted.equals(profile3.get(0))){
            for(int i = 1; i <= 3; i++){
